...
public class MyActivity extends AppCompatActivity {
    public final static String EXTRA_MESSAGE = "com.hunterwells.myapplication.MESSAGE";
    /**
    ...
    */
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.hunterwells.myapplication/http/host/path")
        );
    ...
    private void showAlert() {
        ...
        dialog.setTitle("I'm Blind")
                .setMessage("Turn on my GPS")
                ...
                .setNegativeButton("No I don wanna", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface paramDialogInterface, int paramInt){
                    }
                });
    ...
    private final LocationListener locationListener = new LocationListener(){
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    longitudeLocationTextGPS.setText(longitude + "");
                    latitudeLocationTextGPS.setText(latitude + "");
